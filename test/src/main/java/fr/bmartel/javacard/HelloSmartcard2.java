...
public class HelloSmartcard2 extends Applet implements MultiSelectable {
    short counter = 0x00;

    public static void install(byte[] aArray, short sOffset, byte bLength) {
        new HelloSmartcard2(aArray, sOffset, bLength);
    }

    private HelloSmartcard2(byte[] aArray, short sOffset, byte bLength) {
